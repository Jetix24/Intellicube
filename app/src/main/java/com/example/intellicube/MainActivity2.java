...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button connectToDevice = (Button) findViewById(R.id.button_conectar);
        LinearLayout seachDevices = findViewById(R.id.button_revisar);
        LinearLayout desconectar = findViewById(R.id.button_desconectar);
        Log.d(TAG, "Begin Execution");


        titulo = SeleccionFragment.seleccion_texto;

        imagen = findViewById(R.id.imageView_Incubadora);
        textView_titulo = findViewById(R.id.textView_Incubadora);
            ...
            public void onClick(View view) {
                ...
                if (arduinoBTModule != null) {
                    ...
                    if (ActivityCompat.checkSelfPermission(MainActivity2.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(MainActivity2.this, new String[]{Manifest.permission.BLUETOOTH_CONNECT}, REQUEST_ENABLE_BT);
                    } else {
                        ...
                        connectToBTObservable
                                ...
                                .subscribe(valueRead -> {
                                    ...
                                    if (humidityIndex != -1 && temperatureIndex != -1) {
                                        ...
                                        TextView humidityTextView = findViewById(R.id.textView_humedadIncubadora);
                                        TextView temperatureTextView = findViewById(R.id.textView_tempIncubadora);
